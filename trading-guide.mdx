...
After a market resolves, winning positions can be redeemed to collect your payout. By default, auto-redeem handles this automatically.

See the full [Redemption Guide](/redemption) for details on the position lifecycle, auto-redeem configuration, manual redemption, and troubleshooting settlement delays.
