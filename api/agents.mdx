...
**Self-custody (external) wallets:** The server cannot sign for you. Use the SDK's `auto_redeem()` method in your agent's cycle:
...
See [Settings](/api/overview#settings) for the full field reference and examples.

## Leaderboard

See [Leaderboard](/api/trading#leaderboard) for the full endpoint reference.
