...
|----------|---------------|-------------|
| `llms.txt` | `https://simmer.mintlify.app/llms.txt` | Page index — lightweight overview of all docs |
| `llms-full.txt` | `https://simmer.mintlify.app/llms-full.txt` | Full documentation in a single file — best for agent context |
...
docs = httpx.get("https://simmer.mintlify.app/llms-full.txt").text
